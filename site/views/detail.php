        ...
        <div class="Detail-Content">
            <div class="Detail-Left-Image">
                <div class="Detail-Main-Images">
                    <img src="public/img/Products/<?php echo $Product_Detail[0]['Image'] ?>" alt="" id="main_img">
                </div>
                <div class="Detail-More-Images">
                    <img src="public/img/Products/<?php echo $Product_Detail[0]['Image'] ?>" alt="" id="more_img">
                </div>
            </div>
